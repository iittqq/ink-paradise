	...
	return (
		<Container disableGutters sx={{ minWidth: "100%", minHeight: "100vh" }}>
			...
			>
				...
				<Grid item>
					<Typography sx={{ paddingTop: '25px' , paddingBottom: '25px' ,color: "white" }}>Recently Added</Typography>
				</Grid>
				<Grid 
				container
				direction='column'
				...
				wrap='wrap'
				spacing={1}
				sx={{ overflow: "auto", height: "80vh", scrollbarWidth: "none" , justifyContent:"center"}}
			>
